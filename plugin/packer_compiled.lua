...
_G.packer_plugins = {
  ...
  ["cmp-under-comparator"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/cmp-under-comparator",
